...
- **[foundry-rs/foundry](https://github.com/foundry-rs/foundry)** ★10,626 · 2026-09-26 — the 2026 default. `forge` builds and tests, `anvil` runs a local chain, `cast` makes one-off calls from the command line.
- **[foundry-rs/forge-std](https://github.com/foundry-rs/forge-std)** ★1,058 · 2026-09-26 — the test standard library. Every Foundry project has it.
- **[remix-project-org/remix-project](https://github.com/remix-project-org/remix-project)** ★3,058 · 2026-09-26 — browser IDE, zero install. **Write your first contract today without installing anything.**
- **[NomicFoundation/hardhat](https://github.com/NomicFoundation/hardhat)** ★8,508 · 2026-09-25 — the TypeScript path, now on **Hardhat 3**, and it ships a Foundry compatibility layer. So this is not either/or — it is Solidity tests vs TypeScript tests.
...
- **[AmazingAng/WTF-Solidity](https://github.com/AmazingAng/WTF-Solidity)** ★14,060 · 2026-08-23 — **Chinese; start here if you read Chinese.** The best-maintained Chinese primer, and it is *current*: its first example is already on `pragma solidity ^0.8.34`.
...
2. **[SunWeb3Sec/DeFiHackLabs](https://github.com/SunWeb3Sec/DeFiHackLabs)** ★6,799 · 2026-09-26 — real historical exploits as reproducible Foundry tests. This turns knowledge into instinct; reading someone's post-mortem does not.
3. **[crytic/slither](https://github.com/crytic/slither)** ★6,373 · 2026-09-23 — static analyser. Run it on your own contract before you deploy: free, fast, and it catches the boring class of mistake you should never ship.
...
- **[Cyfrin/security-and-auditing-full-course-s23](https://github.com/Cyfrin/security-and-auditing-full-course-s23)** ★1,964 · 2026-07-08 — the full auditing curriculum.
- **[Anugrahsr/Awesome-web3-Security](https://github.com/Anugrahsr/Awesome-web3-Security)** ★1,624 · 2026-03-01 — the whole surface in one list.
- **[pcaversaccio/snekmate](https://github.com/pcaversaccio/snekmate)** ★602 · 2026-09-26 — optimised building blocks; advanced, but reading it teaches a lot about what careful code looks like.
...
- **[wevm/wagmi](https://github.com/wevm/wagmi)** ★6,753 · 2026-09-07 — React hooks for Ethereum; frontend developers start here.
- **[wevm/viem](https://github.com/wevm/viem)** ★3,568 · 2026-09-25 — the TypeScript interface underneath wagmi.
- Python instead? **[ApeWorX/web3.py](https://github.com/ApeWorX/web3.py)** ★5,533 · 2026-09-25 for a library, **[eth-brownie/brownie](https://github.com/eth-brownie/brownie)** ★2,722 · 2026-08-05 for a framework.
...
- **[Uniswap/v4-core](https://github.com/Uniswap/v4-core)** ★2,535 · 2026-04-24 — read it after v3, to see how a design moves when you are allowed to break it.
...
- **[smartcontractkit/chainlink](https://github.com/smartcontractkit/chainlink)** ★8,249 · 2026-09-26 — oracles, for contracts that need data from outside the chain.
- **[ethereum/go-ethereum](https://github.com/ethereum/go-ethereum)** ★51,371 · 2026-09-25 — the most foundational reference implementation there is. Not a first read; a reference you will come back to.
